...
const experts = [
  ...
  },
  {
    ...
    job: 'Designer',
    photo: '/images/experts/2/expert.jpg',
    socials: [
      {
        icon: '/icons/social/inst.svg',
        name: 'instagram',
